...
export const BOARD_DATA: (Property | { type: SpaceType, name: string })[] = [
  ...
  { name: 'Med Avenue', type: SpaceType.PROPERTY, price: 60, rent: [2, 10, 30, 90, 160, 250], houseCost: 50, color: 'bg-amber-800' },
  ...
  { name: 'Reading Railroad', type: SpaceType.RAILROAD, price: 200, rent: [25, 50, 100, 200],color: 'bg-black-500' },
  ...
  { name: 'Connect Avenue', type: SpaceType.PROPERTY, price: 120, rent: [8, 40, 100, 300, 450, 600], houseCost: 50, color: 'bg-sky-400' },
  { type: SpaceType.JAIL, name: 'Jail / Just Visiting' },
  { name: 'Charles Place', type: SpaceType.PROPERTY, price: 140, rent: [10, 50, 150, 450, 625, 750], houseCost: 100, color: 'bg-pink-500' },
  ...
  { name: 'Pennsy Railroad', type: SpaceType.RAILROAD, price: 200, rent: [25, 50, 100, 200],color: 'bg-black-500' },
  ...
  { name: 'BO Railroad', type: SpaceType.RAILROAD, price: 200, rent: [25, 50, 100, 200],color: 'bg-black-500' },
  ...
  { name: 'North Carolina', type: SpaceType.PROPERTY, price: 300, rent: [26, 130, 390, 900, 1100, 1275], houseCost: 200, color: 'bg-green-600' },
  { type: SpaceType.COMMUNITY_CHEST, name: 'Community Chest' },
  { name: 'Pennsy Avenue', type: SpaceType.PROPERTY, price: 320, rent: [28, 150, 450, 1000, 1200, 1400], houseCost: 200, color: 'bg-green-600' },
  { name: 'Short Line', type: SpaceType.RAILROAD, price: 200, rent: [25, 50, 100, 200],color: 'bg-black-500' },
  { type: SpaceType.CHANCE, name: 'Chance' },
